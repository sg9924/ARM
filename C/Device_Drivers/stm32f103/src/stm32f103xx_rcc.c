...
#include"../inc/stm32f103xx_flash.h"
...
static void RCC_Update_SYSCLK()
{
    ...
    else if(temp == 2)
    {
        ...
        RCCHandle.RCC_Clocks.System_Clock = RCCHandle.RCC_PLL_Config.PLL_clock;
        sysclock = RCCHandle.RCC_Clocks.System_Clock;
    }
    return;
}
...
{
    if(sysclock == SYSCLK_HSI || sysclock == SYSCLK_HSE)
    {
        RCCHandle.RCC_Clocks.System_Clock = sysclock;
    }
